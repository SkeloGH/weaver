...
class WeaverDigest {
   ...
   */
  constructor(config) {
    _defineProperty(this, "dump", results => {
      ...
      const dumpResults = Object.keys(resultsByDb).map(dbName => this.digest(dbName, resultsByDb));
      return Promise.all(dumpResults);
    });

    _defineProperty(this, "digest", (dbName, resultsByDb) => {
    ...
    _defineProperty(this, "saveJSON", results => {
