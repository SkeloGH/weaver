 ...
 */module.exports={/**
   ...
   */queries:[{_id:ObjectId("5bde262fa09d0c95cbc62b38")/* example id, don't panic */},{_id:ObjectId("5bde2691a09d0c95cbc62b4a")/* example id, don't panic */}],/**
   * These are the clients you've configured under `config/clients.js`.
   */dataClients,jsonConfig:{/**
